...
graph TD
    ...
    subgraph System_Architecture [<span></span>]
      ...
      Gateway[API Gateway] --> ReactS & GenAiS & TransactionS & BudgetS & AnalysisS & AuthS


      subgraph Private_Subnet [App Layer]
          GenAiS[GenAIService]

          TransactionS[TransactionsService] -.-> GenAiS

          AnalysisS[NotificationService] -.-> BudgetS
      ...
      %%TransactionS & BudgetS & AnalysisS & GenAiS -.-> AuthS
