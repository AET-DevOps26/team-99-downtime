...
| Bilgehan Savgu ([@bilgehansavgu](https://github.com/bilgehansavgu)) | Java microservices foundation, authentication (Better Auth), React client (UI/shadcn), budget feature  |
